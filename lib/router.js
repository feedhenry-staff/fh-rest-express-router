...
module.exports = function fhRestExpressRouter (opts) {
  ...
  router.get('/', isSupported, validateRequest, doList);
  router.get('/:id', isSupported, doRead);
  router.put('/:id', isSupported, validateRequest, doUpdate);
  router.post('/', isSupported, validateRequest, doCreate);
  router.delete('/:id', isSupported, doDelete);
